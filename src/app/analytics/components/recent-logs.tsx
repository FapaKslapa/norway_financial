...
export function RecentLogs({
  ...
  return (
    <Card className="border border-(--card-border) bg-(--card-solid) shadow-xl p-4 md:p-6 rounded-[2rem] w-full h-full flex flex-col">
      <CardHeader className="p-0 pb-3 md:pb-4 border-b border-(--card-border) mb-3 md:mb-6 flex flex-col items-start gap-1 shrink-0">
      ...
      <CardContent className="p-0 flex-1 min-h-0 overflow-y-auto pr-1 scrollbar-thin flex flex-col">
        {sortedTimeline.length === 0 ? (
          <div className="py-8 text-center text-xs text-(--text-muted) flex flex-col gap-1">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <div className="flex items-center gap-1.5 text-[9px] text-(--text-muted) font-bold uppercase mt-0.5">
                      ...
                      <div className="flex flex-col items-end shrink-0">
                        ...
                        {tx.currency !== displayCurrency && (
                          <span className="text-[8px] text-(--text-muted) font-bold uppercase mt-0.5">
